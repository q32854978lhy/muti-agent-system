...
def main():
    ...
    parser.add_argument('--method', type=str, default="Attention-RL")
    args = parser.parse_args()

    # 定义要绘制的模型的名称以及要显示的最长的episodes
    models = [ 'Attention-RL', 'CADRL','LSTM-RL']
    max_episodes = 10000
    model_out=args.method
